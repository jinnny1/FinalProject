...
$(document).ready(function() {
    ...
    // 공휴일 받아와서 holidayArr에 세팅_매번 요청해서 받아오는데에 시간이 너무 걸려서 다른 방법으로 함.
//     getHolidayData();
...
//                 	console.log(res.dataList[i].empProfile);
//                 	console.log("arr??? : ", arr);
					html += "<tr>";
					html += "   <td>";
					html += "      <h5>";
					if(arr[i].empProfile == null){
						...
						html += "<img src='"+ arr[i].empProfile +"' alt='' class='avatar-sm rounded-circle me-2'>";
...
//        console.log(names);
		...
		for(var j = 0; j < names.length; j++){
		   ...
		   data.empProfile = names[j].empProfile;
