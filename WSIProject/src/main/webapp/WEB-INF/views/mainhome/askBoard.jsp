...
<div class="col-lg-12 justify-content-md-center spacer" style="margin-bottom: 100px;">
    <div class="col-lg-12" align="center">
		<div class="col-lg-8" align="right" style="padding-right: 0px;">
			<div>
        ...
        <table class="table table-hover col-lg-8">
        	<tr style="background-color: #D0DDF3; color: black;">
        		...
        		<th style="width: 18%;">회사 이름</th>
        		<th style="width: 18%; text-align: left;">작성자(사업자등록번호)</th>
        		...
        		<c:otherwise>
        			<c:forEach items="${inqBoardList }" var="inqBoard">
			        	<tr onclick="location.href='/askdetail?inqNo=${inqBoard.inqNo }'" style="cursor:pointer;">
			        		...
			        		<td align="left">${inqBoard.customerVO.cusName }(${inqBoard.cusRnum })</td>
			        		<td align="center">
								<fmt:formatDate value="${inqBoard.inqDate }" pattern="yyyy-MM-dd HH:mm"/>
							</td>
			        		<td align="center">
