...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>404 Error Basic | Dashonic - Admin & Dashboard Template</title>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="text-center py-5">
                            <h1 class="display-1 fw-normal error-text">4<img src="${pageContext.request.contextPath }/resources/assets/images/logo-sm.png" alt=""
                                    class="avatar-lg h-auto mx-2">4</h1>
                            <h4 class="text-uppercase text-muted">Opps, page not found</h4>
                            <div class="mt-5 text-center">
                                <a class="btn btn-primary" href="/home/feed">메인으로</a>
                            </div>
                        </div>
                    </div>
                    <!-- end col -->
