...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>500 Error Basic | Dashonic - Admin & Dashboard Template</title>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="text-center py-5">
                            <h1 class="display-1 fw-normal error-text">5<img src="${pageContext.request.contextPath }/resources/assets/images/logo-sm.png" alt=""
