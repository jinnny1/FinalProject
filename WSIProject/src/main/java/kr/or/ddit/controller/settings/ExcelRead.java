...
import kr.or.ddit.controller.settings.CellRef;
import kr.or.ddit.controller.settings.EmpFileType;
import kr.or.ddit.controller.settings.ReadOption;
...
public class ExcelRead {
    ...
    public static List<Map<String, String>> read(ReadOption readOption) {
         ...
         */
        Workbook wb = EmpFileType.getWorkbook(readOption.getFilePath());
